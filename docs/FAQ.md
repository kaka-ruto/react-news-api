...
### Why does this exist?
I did this to level up in ReactJS, Redux, TDD and related technologies.
...
Streamlined automated testing is a core feature of this app. All tests are placed in files that end in .spec.js. Spec files are placed in the same directory as the file under test. Why?
